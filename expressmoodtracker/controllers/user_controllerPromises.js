...
//this one worked before promies!
...
exports.postLoginBcrypt = async (req, res) => {
  try {
      ...
      const isPasswordCorrect = await bcrypt.compare(userpass, hashedPassword);
      ...
      if (isPasswordCorrect) {
          ...
          let origRoute = session.route || "/allsnapshots";
          return res.redirect(origRoute);
      } else {
          return res.render("login", {
              currentPage: "/login",
              error: "Incorrect password",
